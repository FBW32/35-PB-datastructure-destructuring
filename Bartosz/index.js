...
let {Fran, Sylwia, Radek} = costumes;

console.log(Fran);  //  Witch
console.log(Sylwia); // Doggo
console.log(Radek); // Pirate
...
bandInfo.bandData(); // Regina Spektor is a American-Russian singer/songwriter and pianist. The musician sings indie-pop and their greatest hit is "Us".
