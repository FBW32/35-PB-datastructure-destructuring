...
let {fran, maria, dave} = halloweenCostumes;
console.log(fran);  // witch
console.log(maria); // unicorn
console.log(dave); // clown
...
let musicBand = {
    ...
    hit: "Us",
    bandData() {
        console.log(`${this.name} is a ${this.origin} singer/songwriter and pianist. The musician sings ${this.genre} and their greatest hit is ${this.hit}.`);
    }
};
musicBand.bandData(); // Regina Spektor is a American-Russian singer/songwriter and pianist. The musician sings indie-pop and their greatest hit is Us.
